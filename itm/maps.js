{
  "classes": {
    ...
    "Armsman": {
      "id": 2,
      "races": [ "Briton", "Avalonian", "Highlander", "Saracen", "Inconnu", "Half Ogre" ],
      "cls": [ "Acolyte", "Elementalist", "Disciple", "Mage", "AlbRogue" ],
      "realm": 1,
      "armor": 36,
      "weapons": {
        "2": [ 10, 11 ],
    ...
    "Paladin": {
      "id": 1,
      "races": [ "Briton", "Avalonian", "Highlander", "Saracen" ],
      "cls": [ "Acolyte", "Elementalist", "Disciple", "Mage", "AlbRogue" ],
      "realm": 1,
      "armor": 36,
      "weapons": {
    ...
    "Occultist": {
      "id": 63,
      "races": [ "Briton", "Avalonian" ,"Saracen", "Inconnu" ],
      "cls": [ "Acolyte", "Elementalist", "Mage", "Fighter", "AlbRogue" ],
      "realm": 1,
      "armor": 32,
      "weapons": {
        "8": [ 12 ]
    ...
    "Cabalist": {
      "id": 13,
      "races": [ "Briton", "Avalonian", "Saracen", "Inconnu", "Half Ogre" ],
      "cls": [ "Acolyte", "Elementalist", "Disciple", "Fighter", "AlbRogue" ],
      "realm": 1,
      "armor": 32,
      "weapons": {
        "8": [ 12 ]
    ...
    "Theurgist": {
      ...
      "cls": [ "Acolyte", "Disciple", "Mage", "Fighter", "AlbRogue" ],
      "realm": 1,
      "armor": 32,
      "weapons": {
        "8": [ 12 ]
    ...
    "Cleric": {
      "id": 6,
      "races": [ "Briton", "Avalonian", "Highlander" ],
      "cls": [ "Elementalist", "Disciple", "Mage", "Fighter", "AlbRogue" ],
      "realm": 1,
      "armor": 35,
      "weapons": {
        "2": [ 10, 11 ],
	...
	"Heretic": {
      "id": 33,
      "races": [ "Briton", "Avalonian", "Inconnu" ],
      "cls": [ "Elementalist", "Disciple", "Mage", "Fighter", "AlbRogue" ],
      "realm": 1,
      "armor": 32,
      "weapons": {
    ...
    "Infiltrator": {
      "id": 9,
      "races": [ "Briton", "Saracen", "Inconnu" ],
      "cls": [ "Acolyte", "Elementalist", "Disciple", "Mage", "Fighter" ],
      "realm": 1,
      "armor": 33,
      "weapons": {
        "2": [ 10, 11 ],
    ...
    "Minstrel": {
      "id": 4,
      "races": [ "Briton", "Highlander", "Saracen" ],
      "cls": [ "Acolyte", "Elementalist", "Disciple", "Mage", "Fighter" ],
      "realm": 1,
      "armor": 35,
      "weapons": {
    ...
    "Blademaster": {
      "id": 43,
      "races": [ "Celt", "Firbolg", "Elf", "Shar" ],
      "cls": [ "Naturalist", "Magician", "Forester", "Stalker" ],
      "realm": 3,
      "armor": 37,
      "weapons": {
        "19": [ 10, 11 ],
    ...
    "Valewalker": {
      ...
      "cls": [ "Naturalist", "Magician", "Guardian", "Stalker" ],
      "realm": 3,
      "armor": 32,
      "weapons": {
        "26": [ 12 ]
    ...
    "Vampiir": {
      ...
      "cls": [ "Naturalist", "Magician", "Forester", "Guardian" ],
      "realm": 3,
      "armor": 33,
      "weapons": {
        "21": [ 10, 11 ]
    ...
    "Eldritch": {
      "id": 40,
      "races": [ "Elf", "Lurikeen" ],
      "cls": [ "Naturalist", "Forester", "Guardian", "Stalker" ],
      "realm": 3,
      "armor": 32,
      "weapons": {
        "8": [ 12 ]
    ...
    "Bard": {
      "id": 48,
      "races": [ "Celt", "Firbolg" ],
      "cls": [ "Magician", "Forester", "Guardian", "Stalker" ],
      "realm": 3,
      "armor": 37,
      "weapons": {
        "19": [ 10, 11 ],
    ...
    "Berserker": {
      "id": 31,
      "races": [ "Norseman", "Troll", "Dwarf", "Valkyn" ],
      "cls": [ "Seer", "Mystic", "MidRogue" ],
      "realm": 2,
      "armor": 34,
      "weapons": {
        "11": [ 10, 11, 12 ],
    ...
    "Savage": {
      "id": 32,
      "races": [ "Norseman", "Troll", "Dwarf", "Kobold", "Valkyn" ],
      "cls": [ "Seer", "Mystic", "MidRogue" ],
      "realm": 2,
      "armor": 34,
      "weapons": {
    ...
    "Skald": {
      "id": 24,
      "races": [ "Norseman", "Troll", "Dwarf", "Kobold" ],
      "cls": [ "Seer", "Mystic", "MidRogue" ],
      "realm": 2,
      "armor": 35,
      "weapons": {
    ...
    "Thane": {
      "id": 21,
      "races": [ "Norseman", "Troll", "Dwarf", "Frostalf" ],
      "cls": [ "Seer", "Mystic", "MidRogue" ],
      "realm": 2,
      "armor": 35,
      "weapons": {
    ...
    "Runemaster": {
      "id": 29,
      "races": [ "Norseman", "Dwarf", "Kobold", "Frostalf" ],
      "cls": [ "Seer", "Viking", "MidRogue" ],
      "realm": 2,
      "armor": 32,
      "weapons": {
        "8": [ 12 ]
    ...
    "Spiritmaster": {
      "id": 27,
      "races": [ "Norseman", "Kobold", "Frostalf" ],
      "cls": [ "Seer", "Viking", "MidRogue" ],
      "realm": 2,
      "armor": 32,
      "weapons": {
    ...
    "Hunter": {
      "id": 25,
      "races": [ "Norseman", "Dwarf", "Kobold", "Valkyn", "Frostalf" ],
      "cls": [ "Seer", "Mystic", "Viking" ],
      "realm": 2,
      "armor": 34,
      "weapons": {
        "11": [ 10, 11, 12 ],
  ...
  "realmtitles": {
    "albion": {
      ...
      "rr6": {
        "female": "Phoenix Knight",
        "male": "Phoenix Knight"
      },
      "rr7": {
        "female": "Alerion Knight",
        "male": "Alerion Knight"
      },
      "rr8": {
        "female": "Unicorn Knight",
        "male": "Unicorn Knight"
      },
      "rr9": {
        "female": "Lion Knight",
    ...
    "hibernia": {
      ...
      "rr4": {
        "female": "Grove Protector",
        "male": "Grove Protector"
      },
      "rr5": {
        "female": "Raven Ardent",
        "male": "Raven Ardent"
    ...
    "midgard": {
      ...
      "rr3": {
        "female": "Flammen Vakten",
        "male": "Flammen Vakten"
      },
      "rr4": {
        "female": "Elding Vakten",
        "male": "Elding Vakten"
      },
      "rr5": {
        "female": "Stormur Vakten",
        "male": "Stormur Vakten"
      },
      "rr6": {
        "female": "Isen Fru",
  ...
  "properties": {
    ...
    "167": {
      "name": "Melee: All Dual Wielding Skills",
      "max": "10"
    },
    "168": {
  ...
  "spelltypes": {
    ...
    "79": "Str/Con Debuff",
    "182": "Thrust Debuff",
    "106": "Unbreakable Snare",
    "220": "Weapon Skill Buff",
    ...
    "29": "Defensive Proc",
    "30": "Dexterity Buff",
    "37": "Endurance Regen Buff",
    "229": "Magic Resist Buff",
    "108": "Melee Resist Buff",
    "248": "Omni Heal",
    "47": "Piercing Magic",
    "61": "Power Regen Buff",
    "195": "Power Transfer",
